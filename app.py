...
# --- 1. SUPABASE SETUP ---
# Secrets mein SUPABASE_URL aur SUPABASE_KEY ka hona lazmi hai
...
if menu == "📊 Dashboard":
    ...
    with about_col1:
        ...
        **Hamari Khidmaat:**
        *   **A+ Construction:** Rawalpindi aur Islamabad mein miyari gharon ki tameer.
        *   **Real Estate:** Plots aur houses ki behtareen deals aur investment advice.
        *   **Smart Management:** ERP tools ke zariye project ke har kharche ki hamesha transparency.
        """)
    ...
    with about_col2:
        ...
        <div style="background-color: #1E1E1E; padding: 20px; border-radius: 15px; color: white; border: 1px solid #4B4B4B;">
            ...
            <p style="font-size: 14px;">"Construction mein technology aur imandari la kar client ka bharosa jeetna hamari pehli tarjeeh hai."</p>
            <hr style="border: 0.5px solid #4B4B4B;">
            <p style="font-size: 13px;"><b>Experience:</b> 5+ Years<br>
            <b>Target:</b> Quality & Transparency</p>
        </div>
        """, unsafe_allow_html=True)

    # --- 🟢 SYSTEM SUPPORT & STANDALONE WHATSAPP BUTTON ---
    st.divider()
    supp_col1, supp_col2 = st.columns([2, 1])
    
    with supp_col1:
        st.subheader("🖥️ ERP System Info")
        st.info("Yeh portal Deewary.com ke internal records ke liye design kiya gaya hai. Iska maqsad financial data ko mehfooz aur asaan banana hai.")
    ...
    with supp_col2:
        ...
        <a href="{whatsapp_url}" target="_blank" style="text-decoration: none;">
            <div style="
                ...
                cursor: pointer;
            ">
                <span style="font-size: 22px;">💬</span> WhatsApp Support
            </div>
        </a>
        <style>
            div:hover {{
        ...
        <p style="font-size: 12px; text-align: center; margin-top: 10px; color: #666;">
            Developer: umer sherin | Status: Active ✅
        </p>
        """, unsafe_allow_html=True)
