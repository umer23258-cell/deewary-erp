...
# --- 1. SUPABASE SETUP ---
# Ensure these are set in your .streamlit/secrets.toml or Streamlit Cloud Secrets
...
# Fetch data for use across pages
df = fetch_data()
...
if menu == "📊 Dashboard":
    ...
    # --- TOP SECTION: CAPITAL FLOW (As requested) ---
    ...
    st.markdown("<h3 style='color: #FF4B4B;'>📊 Detailed Task List</h3>", unsafe_allow_html=True)
...
# --- 6. HISTORY PAGES ---
    ...
    if not df.empty:
        ...
        try:
            ...
            st.error("Excel generation error.")
    else:
